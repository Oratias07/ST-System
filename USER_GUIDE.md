...
## 4. Class Management (Sheets View)
Switch to the **Sheets** tab to see your entire class in a grid:
- **Bulk View**: See scores and feedback for all students across all exercises.
- **Manual Overrides**: You can manually click any score or feedback cell to edit it.
